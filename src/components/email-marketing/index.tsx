    ...
    <div className="w-full flex-1 h-0 grid grid-cols-1 lg:grid-cols-2 gap-10">
      ...
      <div>
        <div className="flex flex-wrap gap-3 justify-end">
          ...
          >
            <Plus /> Добавить кампанию
          </Button>
          <Modal
            title="Создайте новую кампанию"
            description="Добавляйте своих клиентов и создавайте маркетинговую кампанию"
            trigger={
          ...
          >
            ...
            >
              ...
              <Button
                ...
                type="submit"
              >
                <Loader loading={loading}>Создать кампанию</Loader>
              </Button>
            </form>
          </Modal>
          <Card className="p-2">
            <CardDescription className="font-bold">
              {subscription?.credits} кредитов
            </CardDescription>
          </Card>
        </div>
                  ...
                  <CardContent className="p-0 flex flex-col items-center gap-3">
                    <div className="flex w-full justify-between items-center">
                      <div className="flex gap-2 items-center">
                        <CalIcon />
                        <CardDescription>
                          Создано {getMonthName(camp.createdAt.getMonth())}{' '}
                      ...
                      <div className="flex gap-2">
                        <PersonIcon />
                        <CardDescription>
                          {camp.customers.length} добавленные клиенты
                        </CardDescription>
                      </div>
                    </div>
                    <div className="flex w-full justify-between items-center">
