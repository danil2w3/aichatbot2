  ...
  return (
    <div className="flex flex-col gap-5 justify-center">
      <div className="flex justify-center">
        <h2 className="text-4xl font-bold mb-5">Запишитесь на встречу</h2>
      </div>
      <div className="flex gap-10 flex-col sm:flex-row">
        <div className="w-[300px]">
          <h6>Ознакомительная встреча</h6>
          <CardDescription>
            На этой встрече мы стремимся исследовать возможные пути для партнерства, 
            рекламные возможности или другие способы, 
            с помощью которых мы можем способствовать успеху вашей компании. 
          </CardDescription>
        </div>
        <div>
          <Calendar
      ...
      <div className="flex gap-5 justify-center mt-5">
        ...
        <Button>
          <Loader loading={loading}>Забронировать сейчас</Loader>
        </Button>
      </div>
    </div>
  )
