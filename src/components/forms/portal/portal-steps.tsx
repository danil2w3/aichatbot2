...
const PortalSteps = ({
  ...
  return (
    <div className="flex flex-col items-center gap-3">
      <h2 className="font-bold text-gray-600 text-4xl">Спасибо</h2>
      <p className="text-center">
        Спасибо, что нашли время заполнить эту форму. Мы с нетерпением ждем
        <br /> встречи с вами в ближайшее время.
      </p>
    </div>
  )
}
