  ...
  return (
    ...
    >
      <div className="flex flex-col gap-3">
        <h2 className="font-bold text-2xl">Настройки домена</h2>
      ...
      <div className="flex flex-col gap-3 mt-5">
        <div className="flex gap-4 items-center">
          <h2 className="font-bold text-2xl">Настройки чат-бота</h2>
      ...
      <div className="flex gap-5 justify-start">
        ...
        >
          <Loader loading={deleting}>Удалить домен</Loader>
        </Button>
        <Button
          type="submit"
          className="w-[100px] h-[50px]"
        >
          <Loader loading={loading}>Сохранить</Loader>
        </Button>
      </div>
    </form>
  )
