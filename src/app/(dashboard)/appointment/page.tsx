...
const Page = async (props: Props) => {
  ...
  return (
    <>
      <InfoBar />
      <div className="grid grid-cols-1 lg:grid-cols-3 flex-1 h-0 gap-5 pr-20 md:pr-4">
        ...
        <div className="col-span-1 ">
          <Section
            ...
            message="Все ваши бронирования на сегодня указаны ниже."
          />
